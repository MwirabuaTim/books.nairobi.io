...
<div class="clearfix" id="a-signin">
  <div class="social-signin">
    <div id="facebook_connect"><a href="#"></a></div>
    <div id="twitter_signin"><a href="#"></a></div>
  </div>
  <form method="post" action="" class="form-horizontal">
	...
	<div class="control-group {{ $errors->has('email') ? 'error' : '' }}">
		...
		<div class="controls">
			<input type="text" name="email" id="email" value="{{ Input::old('email') }}" placeholder="test@test.com" />
	...
	<div class="control-group {{ $errors->has('password') ? 'error' : '' }}">
		...
		<div class="controls">
			<input type="password" name="password" id="password" value="" placeholder="test" />
